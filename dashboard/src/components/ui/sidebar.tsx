...
function Sidebar({
  ...
  return (
    <div
      className={cn(
        "group peer hidden text-sidebar-foreground md:block md:w-[var(--sidebar-width)] md:shrink-0 data-[collapsible=offcanvas]:md:w-0",
        variant === "floating" || variant === "inset"
          ? "data-[collapsible=icon]:md:w-[calc(var(--sidebar-width-icon)+1rem)]"
          : "data-[collapsible=icon]:md:w-[var(--sidebar-width-icon)]"
      )}
      data-state={state}
